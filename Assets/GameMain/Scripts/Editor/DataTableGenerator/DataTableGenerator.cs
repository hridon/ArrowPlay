...
namespace ArrowPlay.Editor.DataTableTools
{
    public sealed class DataTableGenerator
    {
        ...
        [MenuItem("Arrow Play/Generate DataTables")]
        private static void GenerateDataTables()
        {
            foreach (string dataTableName in GetFileNames(DataTablePath))
            {
        ...
        private static void DataTableCodeGenerator(DataTableProcessor dataTableProcessor, StringBuilder codeContent, object userData)
        {
            ...
            codeContent.Replace("__DATA_TABLE_NAME_SPACE__", "ArrowPlay");
        ...
        private static string GenerateDataTableStringParser(DataTableProcessor dataTableProcessor)
        {
            ...
            stringBuilder
                ...
                .AppendLine("        {")
                .AppendLine("            // Arrow Play 示例代码，正式项目使用时请调整此处的生成代码，以处理 GCAlloc 问题！")
