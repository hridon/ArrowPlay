...
namespace ArrowPlay
{
    ...
    /// 怪物类
    /// </summary>
    public class Monstar : Entity
    {
        [SerializeField]
        private MonstarData m_BulletData = null;
...
#endif
        {
            ...
            m_BulletData = userData as MonstarData;
        ...
        void Update()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    bulletWaitTime = 0.8f;
                    //发射弓箭
                    BulletManager.CreateBullet(this.transform.position, ArrowPlayer.transform.position, 0, CampType.Enemy);
                }
            }
        }
