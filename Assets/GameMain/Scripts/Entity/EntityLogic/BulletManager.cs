...
namespace ArrowPlay
{
    ...
    public class BulletManager : MonoBehaviour 
    {
        ...
        public Bullet CreateBullet(Entity entity,Vector3 originalVector3, Vector3 targetVector3, float height, CampType campType,int attack)
        {
            if (list2 == null || list2.Count <= 0)
            {
                ...
                bullet.SetBulletData(new BulletData(1, 2001, entity, campType, attack));
            ...
            {
                list2[0].SetBulletData(new BulletData(1, 2001, entity, campType, attack));
